...
export default function WalletActions() {
  return (
    <div className="flex items-center gap-2 md:gap-6 justify-center">
      <Link
        to="deposit"
        className="rounded-full bg-white text-primary py-1.5 font-medium px-4 text-xs md:text-base flex items-center gap-1.5 cursor-pointer hover:text-primary/80"
      >
