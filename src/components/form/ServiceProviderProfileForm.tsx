                  ...
                  {serviceProviderActivityTabList.map((status, index) => {
                    return (
                      <div>
                        ...
                        {status === 'posts' && (
                          <button className="absolute right-0 top-0 border   border-1 border-primary rounded-full text-primary px-2 py-1 text-xs md:text-sm font-medium flex items-center gap-2 hover:bg-primary hover:text-white">
                            Create a post{' '}
